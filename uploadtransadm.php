...
<head>
  ...
  <title>Upload Transfer Pelelang</title>
        ...
        <div class="costum-file">
          ...
          <div class="row mb-3 mt-4">
            <div class="col-md-12" style="margin-left: 200px">
              ...
              <input type="file" name="gambar" id="inputGroupfile03" aria-describedby="inputGroupfileAddon03" height="300" required oninvalid="this.setCustomValidity('gambar tidak boleh kosong')" oninput="setCustomValidity('')">
