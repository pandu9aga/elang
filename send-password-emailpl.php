...
if(isset($_POST["reset_pass"])){
    ...
    session_start();
    $_SESSION["code"] = "$code";
    $cek = mysqli_query($mysqli, "SELECT * FROM pelelang WHERE email_pelelang = '$emailTo'");
    $hasil = mysqli_fetch_array($cek);
    $idpl = $hasil['id_pelelang'];
    if ($idpl==0) {
      header("location:forgot-passwordpl.php?email=kosong");
    }
    ...
    try {
        ...
        $url = "http://" . $_SERVER["HTTP_HOST"] .dirname($_SERVER["PHP_SELF"]). "/resetpl.php?reset_pass=$code"; //sesuaikan berdasarkan link server dan nama file
        ...
        echo "
            ...
            window.location.href = 'forgot-password-alertpl.php';
            </script>
        ";
